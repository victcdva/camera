package com.example.android.usecam;
    ...
    public void UploadImageToServer(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(MainActivity.this,"Loading...","Wait a moment...", false, false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String FinalData = imageProcessClass.ImageHttpRequest("https://gotnext.webcindario.com/upload.php", HashMapParams);
